...
public class ConfirmDishServedView extends JDialog {
	private static final long serialVersionUID = 1L;
	private JTable table;
	private ArrayList<Object[]> confirmServedProduct;
	private boolean clickOk=false;
	private int maHD;
	
	public ConfirmDishServedView(JFrame owner, int maHD, ArrayList<Object[]> confirmServedProduct) {
		super(owner,"",true);
		this.maHD=maHD;
		this.confirmServedProduct=confirmServedProduct;
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel headerLabel = new JLabel("Xác nhận đã phục vụ món");
		headerLabel.setFont(new Font("Tahoma", Font.BOLD, 15));
		headerLabel.setBounds(133, 13, 231, 24);
		...
		for (int i = 0 ; i<confirmServedProduct.size();i++) {
			model.addRow(confirmServedProduct.get(i));
		}
		...
		date_valueLabel.setBounds(83, 79, 130, 16);
